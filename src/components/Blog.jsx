    ...
    return (
      <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-6 px-2 text-white bg-transparent ">
          <div className="border bg-black w-full min-h-20 rounded-3xl p-4  hover:scale-105 transition-transform duration-300 hover:bg-gradient-to-br from-white/55 to-black">
          ...
          <div className="bg-black border w-full min-h-20 rounded-3xl p-6  hover:scale-105 transition-transform duration-300 hover:bg-gradient-to-br from-white/55 to-black">
