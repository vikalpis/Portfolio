...
export default function Project(){
 ...
 {/*1st */}           
  <div className= "transition-all duration-500 hover:scale-102 cursor-pointer w-full bg-transparent border rounded-xl  hover:bg-gradient-to-br from-white/55 to-black ">
